...
cmdR0="htop"
cmdR1="cd $playDir; ./run_player.sh 6 $device 9966 9967 9968 9969"
cmdL0="cd $synthDir/cpp; ./run.sh 9966"
cmdL1="cd $synthDir/rust; ./run.sh 9967"
cmdL2="cd $synthDir/php; ./run.sh 9968"
cmdL3="cd $synthDir/go; ./run.sh 9969"
